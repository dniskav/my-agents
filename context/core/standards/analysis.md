<!-- Context: standards/analysis | Priority: high | Version: 2.0 | Updated: 2026-05-08 -->
...
- Complexity (method length, module organization)
- Code duplication (extract to shared modules/services)
...
- Coupling and cohesion (boundary clarity)
- Separation of concerns (domain vs. infrastructure vs. presentation)
- Scalability (database design, async processing, caching)
...
### Pattern Discovery
- Search for existing pattern implementations
- Identify conventions followed across the codebase
